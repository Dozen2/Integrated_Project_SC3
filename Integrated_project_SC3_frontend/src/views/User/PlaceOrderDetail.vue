  ...
  <div v-else class="font-sans max-w-7xl mx-auto min-h-[calc(100vh-80px)] p-8 text-gray-800">
    ...
    <div class="flex items-center">
      <h1 class="text-5xl text-blue-500 flex mb-5">
        <span class="mr-2"><PackageOpen size="50" color="#6678ff" /></span>YOUR ORDERS DETAILS
      </h1>
    </div>
    ...
    <div class="relative bg-white rounded-3xl shadow-xl border border-blue-100 p-8 overflow-hidden">
      <!-- แสง gradient เบาๆ -->
      <div class="absolute inset-0 bg-gradient-to-tr from-blue-50 via-transparent to-transparent opacity-70 pointer-events-none"></div>
