        ...
        <div class="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
            <div class="flex-1">
                ...
                <div class="grid grid-cols-4 gap-4 mt-3" v-if="images.length > 1">
                    <div v-for="(img, idx) in images.slice(0, 4)" :key="idx" @click="currentIndex = idx"
            ...
            <div class="flex-1 bg-white p-6 rounded-lg shadow-md">
                <form @submit.prevent="saveProduct" class="space-y-6">
                    <div>
                        <label for="brand" class="block text-sm font-medium text-gray-700">Brand <span
                        ...
                        <div class="mt-1">
                            ...
                            <p v-show="brandError" class="mt-2 text-sm text-red-600">Brand must be selected.</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul v-if="files.length > 0" class="mt-4 space-y-2">
                            <li v-for="(file, index) in files" :key="index"
                                ...
                                <span class="truncate max-w-[200px] text-sm text-gray-800">{{ file.name }}</span>
                    ...
                    <div class="pt-4 flex flex-col sm:flex-row justify-end gap-4">
                        ...
                        <button type="submit"
                            ...
                            :disabled="!isFormValid || (prop.mode === 'Edit' && !isProductChanged)"
                            @click="saveProduct">
                            Save
                        </button>
                    </div>
